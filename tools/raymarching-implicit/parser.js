...
var builtinFunctions = [
    ...
    ["Spiral 1", "k=0.15;r=1/k*ln(sqrt(x^2+y^2));n=0.5^2(x^2+y^2)-0.01sqrt(x^2+y^2)exp(sin(40atan(y,x)));(k*(xcos(r)+ysin(r))-n)^2+z^2=0.1(x^2+y^2)^1.4"],
    ["Spiral 2", "k=0.15&ensp;#&ensp;r=e^kt;p=3.1415926&ensp;#&ensp;pi;#&ensp;polar&ensp;coordinates;r=2sqrt(x^2+y^2);a=atan(y,x);#&ensp;index&ensp;of&ensp;spiral&ensp;layer;n=min((log(r)/k-a)/(2p),1);#&ensp;distance&ensp;to&ensp;logarithmic&ensp;spiral;d(n)=abs(e^(k*(2pn+a))-r);d1=min(d(floor(n)),d(ceil(n)));sqrt(d1^2+4z^2)=0.4r^0.7(1+0.01sin(40a))"],
