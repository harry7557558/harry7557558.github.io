...
I always try to do good, even though I often end up doing bad. (1)
...
I think, therefore I am. I doubt, therefore I'm not. (2)
...
Today, human’s society is too complicated for us to be naked. (1)
SHORT (0.2)
A = {x | x ∉ A} (1)
...
To-do List (1)
DISNEY: (0.3)
Out of the sea, wish I could be, part of your world. -&nbsp;Ariel, The&nbsp;Little&nbsp;Mermaid (1)
Bittersweet and strange, finding you can change, learning you were wrong. -&nbsp;Beauty&nbsp;and&nbsp;the&nbsp;Beast (1)
And at last I see the light, and it's like the fog has lifted. -&nbsp;Rapunzel, Tangled (1)
Do you want to build a snowman? (1)
Don't let them in, don't let them see. Be the good girl you always have to be. -&nbsp;Elsa, Frozen (1)
Here I stand in the light of day. -&nbsp;Elsa, Let&nbsp;It&nbsp;Go (1)
Just stay away and you'll be safe from me!  -&nbsp;Elsa,&nbsp;Frozen (3)
“Sometimes, who we wish we were, what we wish we could do… It’s just not meant to be.” -&nbsp;Moana’s&nbsp;Mother(1)
I've been staring at the edge of the water, Long as I can remember, Never really knowing why.  -&nbsp;Moana, How&nbsp;Far&nbsp;I’ll&nbsp;Go (1)
To the place I know where I cannot go, where I long to be.  -&nbsp;Moana, How&nbsp;Far&nbsp;I’ll&nbsp;Go (2)
See the line where the sky meets the sea? It calls me.  -&nbsp;Moana, How&nbsp;Far&nbsp;I’ll&nbsp;Go (2)
...
Some look for trouble, while others don't.  -&nbsp;Elsa, Frozen&nbsp;II (1)
Sometimes we come last, but we did our best. -&nbsp;Try&nbsp;Everything, Zootopia (1)
"""
LINKS = """
PROFILE (0.3)
...
https://harry7557558.github.io/graph_backup/desmos/index.html | My saved Desmos graphs (3)
https://docs.google.com/document/d/1B7MUQFnMzgEBi-z0o2QsG-hHXcAOOsIbx4dPGrtVTNM/edit | List of quotes on this page (1)
https://harry7557558.github.io/DMOJ-Render_Main/50pointer/%E2%80%8E/index.html | Click me! (1)
TOOLS (0.3)
https://harry7557558.github.io/notes/equations.html | My math note sheet (2)
https://harry7557558.github.io/notes/substitution.html | One of my math notes (1)
https://harry7557558.github.io/tools/chemequ.html | Chemical equation balancer (2)
https://harry7557558.github.io/tools/colorpicker.html | Color picker and convertor (2)
...
https://harry7557558.github.io/Graphics/raytracing/webgl_volume/index.html | WebGL volume rendering (3)
https://harry7557558.github.io/art/dyed-egg/index.html | Random art idea (2)
https://harry7557558.github.io/Graphics/UI/webgl_test/webgl_test_02.html | Random WebGL test (1)
"""
...
with open(".index/quotes.json", "w") as fp:
    json.dump(result, fp)
...
with open(".index/links.json", "w") as fp:
    json.dump(result, fp)
